...
export const TEMPLATE = html`
  <div class="wrapper wrapper_desktop">
    <lr-presence-toggle class="network_problems_splash" bind="visible: presence.networkProblems;">
      ...
      <div class="network_problems_footer">
        <lr-btn-ui theme="primary" text="Retry" bind="onclick: *on.retryNetwork"></lr-btn-ui>
      </div>
    </lr-presence-toggle>
    <div class="viewport">
