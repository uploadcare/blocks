...
ExternalSource.template = html`
  <lr-activity-header>
    ...
    <div>
      <lr-icon bind="@name: activityIcon"></lr-icon>
      <span>{{activityCaption}}</span>
    </div>
    <button type="button" class="mini-btn close-btn" bind="onclick: *historyBack">
  ...
  <div class="content">
    ...
    <div class="toolbar">
      <button type="button" class="cancel-btn secondary-btn" bind="onclick: onCancel" l10n="cancel"></button>
      <div></div>
      <div class="selected-counter"><span l10n="selected-count"></span>{{counter}}</div>
      <button type="button" class="done-btn primary-btn" bind="onclick: onDone; @disabled: !counter">
